...
class CWAttack(AdversarialAttack):
    ...
    def parse_attack_config(self, attack_config_str: str) -> None:
        """
        Parse the string attack_config_str "attack_name,direction,lower_bound,upper_bound" and store each component into a variable
        """
        print(attack_config_str)
        attack_name, direction, lower_bound, upper_bound = attack_config_str.split(',')
