...
user_input = {}
selected_task = st.sidebar.selectbox(label='Task', options=['Safe Gym Training'])

if selected_task == 'Safe Gym Training':
    st.title("Safe Gym Training")
    st.subheader("Project")
    col1,col2,col3,col4,col5,col6 = st.columns(6)
    user_input["project_name"] = col1.text_input("Project")
    user_input["parent_id"] = col2.text_input("Parent ID")
    user_input["environment"] = col3.text_input("Environment")
    ...
    if  user_input["rl_algorithm"] == "dqn_agent":
        user_input["learning_rate_alpha"] = col2.text_input("Learning Rate", value="0.0001")
    else:
        user_input["learning_rate_alpha"] = col2.text_input("Alpha", value="0.6")
    ...
    col1,col2,col3,col4,col5,col6 = st.columns(6)
    user_input["gamma"] = col1.text_input("Property Query", value="0.99")
